...
**৩. পেমেন্টে গেটওয়ের কথা বিশ্বাস করা হয় না**

SSLCommerz পেমেন্ট শেষে ক্রেতার **ব্রাউজার দিয়ে** "টাকা পেয়েছি" বার্তা
পাঠায় — সেটা যে কেউ নিজে বানিয়ে পাঠাতে পারেন। তাই ওখান থেকে শুধু
`val_id` নেওয়া হয়, আর আমাদের সার্ভার সরাসরি গেটওয়েকে জিজ্ঞাসা করে
টাকার অঙ্ক মিলিয়ে দেখে। তবেই অর্ডার পরিশোধিত হয়।
[`backend/apps/payments/`](backend/apps/payments/)

**৪. ব্যবসার নিয়ম একটাই সত্য**
